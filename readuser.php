...
?>   <div class="container">
	<div class="panel-header clearfix">
		...
		<div class="col-sm-1">
			<h2><a href="home.php" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-arrow-left" aria-hidden="true"></span>Back</a><h2>
	    </div>
		<div class="col-sm-1">
...
?> 
    ...
    <h3 class="panel-title"><center>  <font align="left" size=5 color="07522c"><?php echo $row['theme'] ?> </font>  </center> </h3>
		...
		<p><h3><?php echo '<img align="left" src="data:image/jpeg;base64,'.base64_encode($row['name'] ).'" height="180" width="180" class="img-thumnail" /> '?> </h3>
            <?php echo $row['text'] ?></p>
